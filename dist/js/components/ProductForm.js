window.ProductForm = function (navigateTo) {
    ...
    setTimeout(() => {
        // GPS
        window.GPS.getLocation().then(loc => {
            locationData = loc;
        ...
        document.getElementById('product-form').addEventListener('submit', async (e) => {
            ...
            data.activityType = 'product_listing'; // Treat as a special activity type for DB storage
            ...
            navigateTo('profile'); // Go to profile to see dashboard/list
        });
